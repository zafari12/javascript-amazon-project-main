...
//specific type of class (product). clothing inherets from Product
...
export function loadProductsFetch (){
  //creates a promise
  //save the response in the parameter
const promise = fetch(
  'https://supersimplebackend.dev/products'
).then((response)=>{
//to get data from the response. data attached to response
...
export function loadProducts (fun) {
 ...
 //run the function if we get an error
...
/* 
.map() [
product1 (fist element of the array), then run the fuction, 
then creates new Product(product1).
product2, 
into a class. 
]
*/
